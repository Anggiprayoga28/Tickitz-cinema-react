...
const PaymentModal = () => {
  ...
  const paymentMethods = [
    ...
    { id: 'bri', src: '/Bank BRI (Bank Rakyat Indonesia) Logo (SVG-240p) - FileVector69 1.svg' },
      ...
      <div className="max-w-2xl mx-auto bg-white min-h-screen">
        ...
        <div className="bg-gray-300 p-5 flex justify-between items-center">
          <div className="flex flex-col items-center flex-1 relative">
            ...
            <div className="text-xs text-gray-600 text-center">Dates And Time</div>
          ...
          <div className="flex flex-col items-center flex-1 relative">
            <div className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold mb-2 relative z-10">3</div>
        ...
        <form>
          ...
          <div className="mb-9">
            <h2 className="text-xl font-semibold mb-5 text-gray-800">Payment Info</h2>
            
            <div className="mb-4">
              <div className="text-xs text-gray-500 uppercase mb-1 tracking-wider">Date & Time</div>
              <div className="text-sm text-gray-800 font-medium">Tuesday, 07 July 2020 at 02:00pm</div>
            </div>

            <div className="mb-4">
              <div className="text-xs text-gray-500 uppercase mb-1 tracking-wider">Movie Title</div>
              <div className="text-sm text-gray-800 font-medium">Spider-Man: Homecoming</div>
            </div>

            <div className="mb-4">
              <div className="text-xs text-gray-500 uppercase mb-1 tracking-wider">Cinema Name</div>
              <div className="text-sm text-gray-800 font-medium">CineOne21 Cinema</div>
            </div>

            <div className="mb-4">
              <div className="text-xs text-gray-500 uppercase mb-1 tracking-wider">Number of Tickets</div>
              <div className="text-sm text-gray-800 font-medium">3 pieces</div>
            </div>

            <div className="mb-4">
              <div className="text-xs text-gray-500 uppercase mb-1 tracking-wider">Total Payment</div>
              <div className="text-base text-blue-500 font-semibold">$30.00</div>
            </div>
          </div>
          ...
          <div className="mb-9">
            <h2 className="text-xl font-semibold mb-5 text-gray-800">Payment Method</h2>
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
              {paymentMethods.map((method) => (
                ...
                >
                  ...
                  <div className="text-xs text-center text-gray-600">{method.name}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8 relative">
            ...
            <section>
              <div className="flex justify-between items-center mb-5">
                <span className="text-gray-500 text-base">No. Rekening Virtual :</span>
              ...
              <div className="flex justify-between items-center mb-5">
                ...
                <span className="font-semibold text-base text-blue-600">$30.00</span>
              </div>

              <p className="my-8 leading-relaxed text-gray-500">
                Pay this payment bill before it is due,{' '}
                <span className="text-red-600 font-medium">on June 23, 2023</span>. If the bill has not
